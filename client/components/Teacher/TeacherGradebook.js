...
export class TeacherGradebook extends Component {
  constructor(props) {
    super(props)
    this.state = {
      student: '',
  ...
  render() {
    ...
    return (
      <div className="assignmentsByStudent">
        ...
        <div className="gradebookDropDown">
...
export default connect(mapStateToProps, mapDispatchToProps)(TeacherGradebook)
